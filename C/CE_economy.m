...
mex CXXFLAGS="$CXXFLAGS -fopenmp -O3" LDFLAGS="$LDFLAGS -fopenmp" main.cpp economy.cpp ggq_algorithm.cpp econ_functions.cpp math_functions.cpp aux_functions.cpp;
